...
class VideoPlayer:
    ...
    def __init__(self):
        ...
        self.decodebin = None
        self.inFileLocation = "/Users/kemal/WorkSpace/Videowall Development/media/pixar.mp4"

        self.construct_pipeline_2()
    ...
    def construct_pipeline(self):
        ...
        self.filter.link(self.videosink)
    ...
    def construct_pipeline_2(self):
        ...
        self.videoconvert.link(colorspace)
        colorspace.link(self.videosink)
