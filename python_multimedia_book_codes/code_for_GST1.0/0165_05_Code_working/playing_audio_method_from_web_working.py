...
class AudioPlayer:
    ...
    def constructPipeline(self):
        file_url = "http://www.noiseaddicts.com/samples_1w72b820/4353.mp3"
        buf_size = 1024000
        self.player = Gst.ElementFactory.make("playbin")  # playbin2 çalışmıyor nedense...
        self.player.set_property("uri", file_url)
        self.player.set_property("buffer-size", buf_size)
        self.is_playing = False
        self.connectSignals()
