...
class MediaInfo:
    ...
    def fail(self, path):
        print
        "error: %r does not appear to be a media file" % path
        self.__is_media = False
...
class Main(object):
    ...
    def __init__(self):
        ...
        vbox.pack_start(self.videowidget, True, True,
                        0)  # You want to expand the video widget or else you cannot see it
    ...
    def on_window_state_event(self, widget, event):
        ...
        print
        "Is fullscreen: ", self.__is_fullscreen

    def on_file_selected(self, widget):
        print
        "Selected: ", self.load_file_button.get_filename()
    ...
    def on_play_clicked(self, widget):
        ...
        "play clicked"
        print
        "Video (width, height): ", self.file_info.get_width(), self.file_info.get_height()
